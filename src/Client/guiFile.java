...
public class guiFile extends javax.swing.JFrame {
	...
	public boolean prepare(String u, String h, int p, ChatBox m) {
		this.host = h;
		this.myusername = u;
		this.port = p;
		this.main = m;
	...
	class SendFileThread implements Runnable {
		private guiFile form;

		public SendFileThread(guiFile form) {
			this.form = form;
		}
			...
			try {
				while (!Thread.currentThread().isInterrupted()) {
					...
					case "CMD_RECEIVE_FILE_ERROR": // Định dạng: CMD_RECEIVE_FILE_ERROR [Message]
						...
						JOptionPane.showMessageDialog(guiFile.this, msg, "Lỗi", JOptionPane.ERROR_MESSAGE);
						this.closeMe();
						break;
					...
					case "CMD_RECEIVE_FILE_ACCEPT": // Định dạng: CMD_RECEIVE_FILE_ACCEPT [Message]
						...
						new Thread(new guiFileThread(socket, file, sendTo, myusername, guiFile.this)).start();
						break;
					...
					case "CMD_SENDFILEERROR":
						...
						JOptionPane.showMessageDialog(guiFile.this, emsg, "Lỗi", JOptionPane.ERROR_MESSAGE);
						form.updateAttachment(false);
					...
					case "CMD_SENDFILERESPONSE":
						...
						form.updateAttachment(false);
						JOptionPane.showMessageDialog(guiFile.this, rMsg, "Lỗi", JOptionPane.ERROR_MESSAGE);
						dispose();
						break;
					}
				}
						...
						.addGroup(layout.createSequentialGroup().addGroup(layout
								...
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
										.addGroup(layout.createSequentialGroup()
												.addComponent(progressbar, javax.swing.GroupLayout.PREFERRED_SIZE, 222,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
												.addComponent(btnSendFile))
										.addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout
												.createSequentialGroup()
												.addComponent(txtFile, javax.swing.GroupLayout.PREFERRED_SIZE, 230,
														javax.swing.GroupLayout.PREFERRED_SIZE)
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addGap(19, 19, 19).addComponent(jLabel1)
						...
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(btnBrowse).addComponent(txtFile, javax.swing.GroupLayout.PREFERRED_SIZE,
										32, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(23, 23, 23).addComponent(jLabel2)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(txtSendTo, javax.swing.GroupLayout.PREFERRED_SIZE, 30,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(btnSendFile, javax.swing.GroupLayout.PREFERRED_SIZE, 29,
										javax.swing.GroupLayout.PREFERRED_SIZE)
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(guiFile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
